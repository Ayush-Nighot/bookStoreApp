    ...
    <>
      <div className="my-10 max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row ">
        <div className="order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32">
          <div className="space-y-6">
            ...
            <p className="text-xl">
              ...
              Asperiores laboriosam dicta tempore alias ea rerum reprehenderit
              facere, deserunt cumque vel consequatur illum laborum minima odio.
            </p>
        ...
        <div className="order-1 w-full md:w-1/2">
          <img src={bannerr} className="w-92 h-92" alt="Error Loading image"/>
        </div>
      </div>
    </>
  );
